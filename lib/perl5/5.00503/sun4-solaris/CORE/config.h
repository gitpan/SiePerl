 ...
 */
#define ARCHLIB "/usr/local/lib/perl5/5.00503/sun4-solaris"		/**/
#define ARCHLIB_EXP "/usr/local/lib/perl5/5.00503/sun4-solaris"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB "/usr/local/lib/perl5/5.00503"		/**/
#define PRIVLIB_EXP "/usr/local/lib/perl5/5.00503"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/perl5/site_perl/5.005/sun4-solaris"		/**/
#define SITEARCH_EXP "/usr/local/lib/perl5/site_perl/5.005/sun4-solaris"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITELIB "/usr/local/lib/perl5/site_perl/5.005"		/**/
#define SITELIB_EXP "/usr/local/lib/perl5/site_perl/5.005"		/**/
